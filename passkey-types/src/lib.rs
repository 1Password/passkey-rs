...
//! specifications for the operations they define. They are each seperated in their own modules.
//!
//! ## Webauthn
//!
...
//! `Response` types are defined in seperate modules for each operation. These types make use of the
