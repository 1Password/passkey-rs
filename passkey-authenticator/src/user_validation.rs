...
pub trait UserValidationMethod {
    /// Defines the type used to decide if user verification should be forced.
    ...
    /// also require the user to verify their identity.
    ///
    ...
    /// * `verification` - Indicates whether the user's identitfy should be verified.
    async fn check_user(
        &self,
