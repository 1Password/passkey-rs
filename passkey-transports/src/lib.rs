...
//!
//! This crate implements the CTAP2 transports between the client and the authenticator. The
//! direction is from the perspective of the client. This is used in the case when the authenticator
//! is not internal to the client's program but accessible as another process or device.
//!
//! Currently only the USB [`hid`] transport is implemented with plans to support the other specified
//! transports as well as the different platform authenticators.
//!
//!
